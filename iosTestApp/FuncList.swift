...
//        httpURL = readStringFromTxtFile(with: "info_data").trimmingCharacters(in: ["\n"])
    ...
    //Log Data Get
    func logDataGet(PanID: String, SelectDate: String, FileName: String) -> String {
        print("logDataGet")
        ...
        let url = URL(string: httpURL[0]+":3737/filesystem/" + PanID + "/LOG/" + SelectDate + "/" + FileName)
        var request = URLRequest(url: url!)
        request.httpMethod = "get"
